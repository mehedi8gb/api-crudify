...
class ApiCrudify extends Command
{
    ...
    public function handle(): void
    {
        ...
        $this->info("Controller created: {$controllerFileName}");
    ...
    private function generateAndSaveFormRequests(array $modelBinding): void
    {
        ...
        $this->info("Update Form requests created: <fg=yellow>{$formRequestUpdateFileName}</>");
    }
    ...
    private function generateAndSaveResource(array $modelBinding): void
    {
        ...
        $this->info("Resource collection created: <fg=yellow>{$resourceCollectionFileName}</>");
    }
